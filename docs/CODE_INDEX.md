...
Generated: 2026-09-12T18:16:36.304Z
Git SHA: 7d92420
...
- **/api/experience-types/[id]** (PATCH)  
  - file: `app/api/experience-types/[id]/route.ts`
- **/api/experience-types** (GET, POST)  
  - file: `app/api/experience-types/route.ts`
- **/api/experiences/[id]** (PATCH)  
  - file: `app/api/experiences/[id]/route.ts`
...
- **/api/lodgify/webhook** (POST)  
  - file: `app/api/lodgify/webhook/route.ts`
- **/api/lodgify/webhook/subscribe** (GET, POST)  
  - file: `app/api/lodgify/webhook/subscribe/route.ts`
