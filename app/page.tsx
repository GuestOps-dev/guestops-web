...
export default function Home() {
  return (
    <main className="marketing-page">
      ...
      <section className="marketing-inquiry" id="inquire"><div className="marketing-inquiry-copy"><p className="marketing-section-kicker">Let&apos;s talk</p><h2>Ready to make guest operations feel lighter?</h2><p>Tell us a little about your portfolio and we&apos;ll be in touch to discuss what GuestOpsHQ could look like for your team.</p><div className="marketing-contact-detail"><span>✦</span><a href="mailto:info@guestopshq.com">info@guestopshq.com</a></div></div><InquiryForm /></section>
